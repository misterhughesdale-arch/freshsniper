...
const CONFIG = {
  ...
  PUMP_TOKEN_PROGRAM: new PublicKey("6EF8rrecthR5Dkzon8Nwu78hRvfCKubJ14M5uBEwF6P"), // Use main program - potentially faster
...
const DISCRIMINATORS = {
  CREATE: Buffer.from([24, 30, 200, 40, 5, 28, 7, 119]), // From IDL
